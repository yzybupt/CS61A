...
def inc_subseqs(s):
    ...
    """
    #I don not know how to solve this problem, I just copid the official solution from CS61A website and paseted it here
...
def make_glookup(class_assignments):
    ...
    currentTotal = 0
    currentPoints = 0
    def f(homework, point):
        nonlocal currentPoints
        nonlocal currentTotal
        currentPoints = currentPoints + point
        currentTotal = currentTotal + class_assignments[homework]
        return currentPoints / currentTotal
    return f
